...
public class Main extends Application {
        ...
        public void start(Stage stage) {
            ...
            Menu themeSubMenu = new Menu("Themes");
            ...
            RadioMenuItem theme1 = new RadioMenuItem("Light");
            RadioMenuItem theme2 = new RadioMenuItem("Dark");
            RadioMenuItem theme3 = new RadioMenuItem("Ocean");
            ...
            CheckMenuItem simpleMode = new CheckMenuItem("Expert Mode");
            ...
            simpleMode.setOnAction(e -> {
                    if(vbox.getChildren().size() == 4){
                        ...
                        vbox.getChildren().add(1, numGrid);
                    }
            });
