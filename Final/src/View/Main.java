...
//            });
    ...
    public static void main(String[] args) {
        ...
        String userFunctionCallTest = "2^(tim(15, cos(28), hey(6))+ hey(5))";

        // prints the replacement string with arguments in the right place
        System.out.println(Model.UserFunctions.replaceUserFunctionsInExpression(userFunctionCallTest));
