	...
	public static void main(String[] args) {
		...
		while(true){
			...
			switch (function) {
				...
				case "subtraction": {
					System.out.printf("%"+decimallength+"f \n",MathFunctions.subtract(arguments));
					break;
				}
				case "multiplication": {
					System.out.printf("%"+decimallength+"f \n",MathFunctions.multiply(arguments));
					break;
				}
				case "division": {
				...
				case "root": {
					if (arguments[1]!=(int)arguments[1]){
						...
						System.out.printf("%"+decimallength+"f \n",MathFunctions.nroot(arguments[0], (int) arguments[1]));
					}
				}
				case "factorial": {
					if (arguments[0]!=(int)arguments[0]) {
						...
						System.out.printf("%"+decimallength+"f \n",MathFunctions.factorial((int) arguments[0]));
						break;
					}
				}
				case "ln":{
