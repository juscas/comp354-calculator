...
//			System.out.println();
	...
	static double realPower(double base, double exponent){
		...
		if(exponent==(int)exponent){
			...
			//the answer of the previous calculation would be raised to the decimalExp's power, which would give us the estimated
			//answer for power of an exponent between 0 and 1 (decimal)
			return 0;
